...
<div class="container-fluid py-5">
  <div class="row px-xl-5">
      ...
      <div class="col-lg-7 pb-5">
          <h3 class="font-weight-semi-bold"><?= $nama_produk; ?></h3>
          ...
          <div class="d-flex">
            <h3 class="font-weight-semi-bold mb-4"><?= formatRupiah($diskon > 0 ? $harga - (int) $harga * (int) $diskon / 100 : $harga); ?></h3>&nbsp;&nbsp;&nbsp;
            <?php
              if ($diskon > 0) { ?>
                <h3 class="text-muted mb-4"><del><?= formatRupiah($harga); ?></del></h3>
              <?php }
            ?>
          </div>
          <p class="mb-4">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="media mb-4">
                        <img src="<?= base_url(); ?>assets/eshopper/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
            ...
            <div class="owl-carousel related-carousel">
                <div class="card product-item border-0">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="<?= base_url(); ?>assets/eshopper/img/product-1.jpg" alt="">
                    </div>
                ...
                <div class="card product-item border-0">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="<?= base_url(); ?>assets/eshopper/img/product-2.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Colorful Stylish Shirt</h6>
                        <div class="d-flex justify-content-center">
                ...
                <div class="card product-item border-0">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="<?= base_url(); ?>assets/eshopper/img/product-3.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Colorful Stylish Shirt</h6>
                        <div class="d-flex justify-content-center">
                ...
                <div class="card product-item border-0">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="<?= base_url(); ?>assets/eshopper/img/product-4.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Colorful Stylish Shirt</h6>
                        <div class="d-flex justify-content-center">
                ...
                <div class="card product-item border-0">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="<?= base_url(); ?>assets/eshopper/img/product-5.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Colorful Stylish Shirt</h6>
                        <div class="d-flex justify-content-center">
